...
namespace FinanceTrackerAPI.Controllers.Tests
{
    ...
    public class CategoriesTests : TestBase
    {
        ...
        public CategoriesTests() : base("FinanceTrackerAPI_TestDBCategories")
        {
        }
        ...
        public async Task PutCategory()
        {
            ...
            var content = new StringContent(jsonContent, System.Text.Encoding.UTF8, "application/json");
            // Act
            var response = await Client.PutAsync($"/api/Categories/{updatedCategory.CategoryId}", content);
            response.EnsureSuccessStatusCode();
            // Assert
            var updatedResponse = await Client.GetAsync($"/api/Categories/{updatedCategory.CategoryId}");
        ...
        public async Task DeleteCategoryWithChildrenFails()
        {
            ...
            // Act
            response = await Client.DeleteAsync($"/api/Categories/{categoryId}");
            // Assert
    ...
    [TestClass]
    public class GetCategoryByIdTest : TestBase
    {

        public GetCategoryByIdTest() : base("FinanceTrackerAPI_TestDBCategories")
        {
        }
        protected override void SeedTestData()
        {
